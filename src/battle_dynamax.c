...
{
    {SPECIES_KAZEIYAGA_GIGANTAMAX,                   TYPE_GRASS,      MOVE_G_MAX_VINE_LASH},
    {SPECIES_LEVIAMAWL_GIGANTAMAX,                  TYPE_WATER,      MOVE_G_MAX_CANNONADE},
    {SPECIES_SOLADOR_GIGANTAMAX,                  TYPE_FIRE,       MOVE_G_MAX_WILDFIRE},
    {SPECIES_CYCLIL_GIGANTAMAX,                 TYPE_BUG,        MOVE_G_MAX_BEFUDDLE},
    {SPECIES_FOMPOUS_GIGANTAMAX,                    TYPE_ELECTRIC,   MOVE_G_MAX_VOLT_CRASH},
    {SPECIES_YOCKU_GIGANTAMAX,                     TYPE_NORMAL,     MOVE_G_MAX_GOLD_RUSH},
    {SPECIES_GRAPPOUCH_GIGANTAMAX,                    TYPE_FIGHTING,   MOVE_G_MAX_CHI_STRIKE},
