...
{
    HOENN_TO_NATIONAL(GANERA),
    HOENN_TO_NATIONAL(GYANNEX),
    HOENN_TO_NATIONAL(KAZEIYAGA),
    HOENN_TO_NATIONAL(TEPILLA),
    HOENN_TO_NATIONAL(ESCORCHES),
    HOENN_TO_NATIONAL(SOLADOR),
    HOENN_TO_NATIONAL(RELENTOOTH),
    HOENN_TO_NATIONAL(SNARETHAN),
    HOENN_TO_NATIONAL(LEVIAMAWL),
    HOENN_TO_NATIONAL(COATTAIL),
    HOENN_TO_NATIONAL(COATOAC),
    HOENN_TO_NATIONAL(CYCLIL),
    HOENN_TO_NATIONAL(ROADILLO),
    HOENN_TO_NATIONAL(FELIGHT),
    HOENN_TO_NATIONAL(SILWING),
    HOENN_TO_NATIONAL(DISCUTTLE),
    HOENN_TO_NATIONAL(TENNADISH),
    HOENN_TO_NATIONAL(WEBILLITE),
    HOENN_TO_NATIONAL(BANANEE),
    HOENN_TO_NATIONAL(BANAGON),
    HOENN_TO_NATIONAL(SALANANA),
    HOENN_TO_NATIONAL(TADEA),
    HOENN_TO_NATIONAL(BATRACHITE),
    HOENN_TO_NATIONAL(TOAGNITIVE),
    HOENN_TO_NATIONAL(FOMPOUS),
    HOENN_TO_NATIONAL(ASTROHAUT),
    HOENN_TO_NATIONAL(XENOWEED),
    HOENN_TO_NATIONAL(COILARVA),
    HOENN_TO_NATIONAL(MORPHYDRA),
    HOENN_TO_NATIONAL(DRAMAGO),
    HOENN_TO_NATIONAL(RUMOSS),
    HOENN_TO_NATIONAL(LIAYARD),
    HOENN_TO_NATIONAL(CYBIRD),
    HOENN_TO_NATIONAL(PTEROCAST),
    HOENN_TO_NATIONAL(BEWANDER),
    HOENN_TO_NATIONAL(BEWARER),
    HOENN_TO_NATIONAL(BEWONDER),
    HOENN_TO_NATIONAL(REBUGGER),
    HOENN_TO_NATIONAL(MYRIEPROM),
    HOENN_TO_NATIONAL(AMPRABICA),
    HOENN_TO_NATIONAL(CAFFINERGY),
    HOENN_TO_NATIONAL(NITTLE),
    HOENN_TO_NATIONAL(SEARTICA),
    HOENN_TO_NATIONAL(AMBLAZIA),
    HOENN_TO_NATIONAL(SILICTAL),
    HOENN_TO_NATIONAL(CRYSTURDY),
    HOENN_TO_NATIONAL(QUARDIAN),
    HOENN_TO_NATIONAL(SCRILL),
    HOENN_TO_NATIONAL(OVERSCRILL),
    HOENN_TO_NATIONAL(YOCKU),
    HOENN_TO_NATIONAL(KURAIJIN),
    HOENN_TO_NATIONAL(THUNDAIJU),
    HOENN_TO_NATIONAL(SWORMO),
    HOENN_TO_NATIONAL(SILKRYSTAL),
    HOENN_TO_NATIONAL(ARACHTITE),
    HOENN_TO_NATIONAL(CRAGOYLE),
    HOENN_TO_NATIONAL(GARGANTIC),
    HOENN_TO_NATIONAL(PUPPETTE),
    HOENN_TO_NATIONAL(VENTRILETTE),
    HOENN_TO_NATIONAL(CARRIONETTE),
    HOENN_TO_NATIONAL(FEISTYCUFF),
    HOENN_TO_NATIONAL(KNUCKOUT),
    HOENN_TO_NATIONAL(PHISHOOKE),
    HOENN_TO_NATIONAL(MACKARREL),
    HOENN_TO_NATIONAL(SNOUTUSSLE),
    HOENN_TO_NATIONAL(GRAPPOUCH),
    HOENN_TO_NATIONAL(BANSHARK),
    HOENN_TO_NATIONAL(SOBANDIT),
    ...
    HOENN_TO_NATIONAL(WIRLIXPLOR),
    HOENN_TO_NATIONAL(GALACTIVY),
...
u16 GetEvolutionTargetSpecies(struct Pokemon *mon, u8 mode, u16 evolutionItem, struct Pokemon *tradePartner)
{
    ...
    if (holdEffect == HOLD_EFFECT_PREVENT_EVOLVE
        ...
        && (P_KNUCKOUT_EVERSTONE < GEN_4 || species != SPECIES_KNUCKOUT))
        return SPECIES_NONE;
    ...
    // Fompous, Yocku, and Eevee cannot evolve if they have the
...
u16 GetSpeciesPreEvolution(u16 species)
{
    ...
    for (i = SPECIES_GANERA; i < NUM_SPECIES; i++)
    {
