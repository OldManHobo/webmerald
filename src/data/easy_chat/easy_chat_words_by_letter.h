...
const u16 gEasyChatWordsByLetter_A[] = {
    ...
    EC_WORD_ABOVE,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(FEISTYCUFF),
    EC_POKEMON_NATIONAL(FEISTYCUFF),
    EC_WORD_ABSENT,
    EC_POKEMON(ABSOL),
    EC_WORD_ABSOLUTELY,
    EC_MOVE(ABSORB),
    ...
    EC_WORD_AIYEEH,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(PHISHOOKE),
    EC_POKEMON_NATIONAL(PHISHOOKE),
    EC_WORD_ALL,
    EC_WORD_ALL_RIGHT,
    EC_WORD_ALLOW,
    EC_WORD_ALLOWANCE,
    ...
    EC_WORD_APPRECIATE,
    EC_WORD_APPROVED,
    EC_POKEMON_NATIONAL(TOAGNITIVE),
    EC_POKEMON_NATIONAL(GARGANTIC),
    EC_WORD_ARE,
    EC_WORD_AREN_T,
    EC_WORD_ARENA_TRAP,
...
const u16 gEasyChatWordsByLetter_B[] = {
    ...
    EC_WORD_BUG,
    EC_POKEMON_NATIONAL(GANERA),
    EC_MOVE2(BULK_UP),
    EC_MOVE2(BULLET_SEED),
    EC_WORD_BUSY,
    EC_WORD_BUT,
    EC_POKEMON_NATIONAL(CYCLIL),
    EC_WORD_BYE_BYE,
};
...
const u16 gEasyChatWordsByLetter_C[] = {
    ...
    EC_MOVE(CHARGE),
    EC_POKEMON_NATIONAL(SOLADOR),
    EC_MOVE(CHARM),
    EC_POKEMON_NATIONAL(TEPILLA),
    EC_POKEMON_NATIONAL(ESCORCHES),
    EC_WORD_CHAT,
    ...
    EC_POKEMON(CLAYDOL),
    EC_WORD_CLEAR_BODY,
    EC_POKEMON_NATIONAL(PTEROCAST),
    EC_POKEMON_NATIONAL(CYBIRD),
...
const u16 gEasyChatWordsByLetter_D[] = {
    ...
    EC_WORD_DUDE,
    EC_POKEMON_NATIONAL(OVERSCRILL),
...
const u16 gEasyChatWordsByLetter_E[] = {
    ...
    EC_WORD_EH_QUES,
    EC_WORD_EHEHE,
    EC_POKEMON_NATIONAL(BATRACHITE),
...
const u16 gEasyChatWordsByLetter_G[] = {
    ...
    EC_WORD_GOING,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(AMPRABICA),
    EC_POKEMON_NATIONAL(AMPRABICA),
    EC_WORD_GOLD,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(GOLDEEN),
...
const u16 gEasyChatWordsByLetter_I[] = {
    ...
    EC_WORD_IT_S,
    EC_WORD_ITEM,
    EC_POKEMON_NATIONAL(GYANNEX),
};

const u16 gEasyChatWordsByLetter_J[] = {
    DOUBLE_SPECIES_NAME
    EC_POKEMON(BEWONDER),
    EC_POKEMON_NATIONAL(BEWONDER),
    EC_POKEMON(JIRACHI),
    EC_WORD_JOKING,
...
const u16 gEasyChatWordsByLetter_K[] = {
    ...
    DOUBLE_SPECIES_NAME
    EC_POKEMON(KNUCKOUT),
    EC_POKEMON_NATIONAL(KNUCKOUT),
    EC_POKEMON_NATIONAL(FELIGHT),
...
const u16 gEasyChatWordsByLetter_M[] = {
    EC_MOVE2(MACH_PUNCH),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(GRAPPOUCH),
    EC_POKEMON_NATIONAL(GRAPPOUCH),
    EC_WORD_MACHINE,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(SNOUTUSSLE),
    EC_POKEMON_NATIONAL(SNOUTUSSLE),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(MACKARREL),
    EC_POKEMON_NATIONAL(MACKARREL),
    EC_WORD_MAGAZINE,
    ...
    EC_POKEMON_NATIONAL(SILKRYSTAL),
...
const u16 gEasyChatWordsByLetter_N[] = {
    ...
    EC_WORD_NEXT,
    EC_WORD_NICE,
    EC_POKEMON_NATIONAL(LIAYARD),
    EC_POKEMON_NATIONAL(MORPHYDRA),
    EC_POKEMON_NATIONAL(XENOWEED),
    EC_POKEMON_NATIONAL(DRAMAGO),
    EC_POKEMON_NATIONAL(COILARVA),
    EC_POKEMON_NATIONAL(RUMOSS),
    EC_WORD_NIGHT,
...
const u16 gEasyChatWordsByLetter_O[] = {
    ...
    DOUBLE_SPECIES_NAME
    EC_POKEMON(CAFFINERGY),
    EC_POKEMON_NATIONAL(CAFFINERGY),
    EC_MOVE(ODOR_SLEUTH),
    EC_WORD_OF,
    EC_WORD_OFF,
    EC_WORD_OFFENSIVE,
...
const u16 gEasyChatWordsByLetter_P[] = {
    EC_MOVE(PAIN_SPLIT),
    EC_POKEMON_NATIONAL(AMBLAZIA),
    EC_POKEMON_NATIONAL(SILICTAL),
    EC_WORD_PARDON,
    EC_WORD_PARENT,
    EC_WORD_PARTNER,
    EC_WORD_PARTY,
    ...
    EC_WORD_PICKUP,
    EC_POKEMON_NATIONAL(FLUTTERPOP),
    EC_POKEMON_NATIONAL(PUPACRACK),
    EC_POKEMON_NATIONAL(FUZZSNAP),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(FOMPOUS),
    EC_POKEMON_NATIONAL(FOMPOUS),
    ...
    EC_POKEMON_NATIONAL(PUPPETTE),
    EC_POKEMON_NATIONAL(VENTRILETTE),
    EC_POKEMON_NATIONAL(CARRIONETTE),
    ...
    DOUBLE_SPECIES_NAME
    EC_POKEMON(THUNDAIJU),
    EC_POKEMON_NATIONAL(THUNDAIJU),
    EC_MOVE(PSYWAVE),
...
const u16 gEasyChatWordsByLetter_R[] = {
    ...
    EC_MOVE(RAGE),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(ASTROHAUT),
    EC_POKEMON_NATIONAL(ASTROHAUT),
    ...
    EC_WORD_RARE,
    EC_WORD_RATHER,
    EC_POKEMON_NATIONAL(BANAGON),
    EC_POKEMON_NATIONAL(BANANEE),
    EC_POKEMON(RAYQUAZA),
    EC_MOVE2(RAZOR_LEAF),
    EC_MOVE(RAZOR_WIND),
    EC_WORD_READY,
...
const u16 gEasyChatWordsByLetter_S[] = {
    ...
    EC_MOVE(SAND_ATTACK),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(WIRLIXPLOR),
    EC_POKEMON_NATIONAL(WIRLIXPLOR),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(GALACTIVY),
    EC_POKEMON_NATIONAL(GALACTIVY),
    EC_MOVE(SANDSTORM),
    EC_WORD_SAPPHIRE,
    EC_WORD_SATISFIED,
    EC_WORD_SATURDAY,
    ...
    EC_WORD_SPORTS,
    EC_WORD_SPRING,
    EC_POKEMON_NATIONAL(RELENTOOTH),
    EC_WORD_STAGE,
...
const u16 gEasyChatWordsByLetter_V[] = {
    ...
    EC_POKEMON_NATIONAL(QUARDIAN),
    EC_POKEMON_NATIONAL(CRYSTURDY),
    EC_POKEMON_NATIONAL(KAZEIYAGA),
    EC_WORD_VERSION,
    EC_WORD_VERSUS,
    EC_WORD_VERY,
    EC_POKEMON(VIBRAVA),
...
const u16 gEasyChatWordsByLetter_W[] = {
    ...
    EC_WORD_WEDNESDAY,
    EC_POKEMON_NATIONAL(ROADILLO),
    EC_WORD_WEEK,
    EC_POKEMON_NATIONAL(SOBANDIT),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(WEEZING),
...
const u16 gEasyChatWordsByLetter_Z[] = {
    ...
    DOUBLE_SPECIES_NAME
    EC_POKEMON(MYRIEPROM),
    EC_POKEMON_NATIONAL(MYRIEPROM),
};
