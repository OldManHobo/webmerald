...
const u16 DecorGfx_FOMPOUS_DOLL[] = {
    OBJ_EVENT_GFX_FOMPOUS_DOLL
};
...
const u16 DecorGfx_BEWONDER_DOLL[] = {
    OBJ_EVENT_GFX_BEWONDER_DOLL
};

const u16 DecorGfx_YOCKU_DOLL[] = {
    OBJ_EVENT_GFX_YOCKU_DOLL
};
...
const u16 DecorGfx_KAZEIYAGA_DOLL[] = {
    OBJ_EVENT_GFX_BIG_KAZEIYAGA_DOLL
};

const u16 DecorGfx_SOLADOR_DOLL[] = {
    OBJ_EVENT_GFX_BIG_SOLADOR_DOLL
};

const u16 DecorGfx_LEVIAMAWL_DOLL[] = {
    OBJ_EVENT_GFX_BIG_LEVIAMAWL_DOLL
};
