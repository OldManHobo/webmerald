const u32 *const gDecorIconTable[][2] =
{
    ...
    [DECOR_BEWONDER_DOLL] = {NULL, NULL},
    [DECOR_YOCKU_DOLL]     = {NULL, NULL},
    [DECOR_CYBIRD_DOLL]   = {NULL, NULL},
    ...
    [DECOR_KAZEIYAGA_DOLL]   = {gDecorIcon_KazeiyagaDoll, gDecorIconPalette_KazeiyagaDoll},
    [DECOR_SOLADOR_DOLL]  = {gDecorIcon_SoladorDoll, gDecorIconPalette_SoladorDoll},
    [DECOR_LEVIAMAWL_DOLL]  = {gDecorIcon_LeviamawlDoll, gDecorIconPalette_LeviamawlDoll},
