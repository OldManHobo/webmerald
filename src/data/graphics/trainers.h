...
const u32 gTrainerFrontPic_LeaderErma[] = INCBIN_U32("graphics/trainers/front_pics/leader_erma.4bpp.lz");
const u32 gTrainerPalette_LeaderErma[] = INCBIN_U32("graphics/trainers/front_pics/leader_erma.gbapal.lz");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(LEADER_ERMA, LeaderErma),
};
