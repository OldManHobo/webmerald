const struct FacilityMon gBattleFrontierMons[NUM_FRONTIER_MONS] =
{
    ...
    [FRONTIER_MON_COATOAC] = {
        .species = SPECIES_COATOAC,
        .moves = {MOVE_HARDEN, MOVE_NONE, MOVE_NONE, MOVE_NONE},
        .itemTableId = BATTLE_FRONTIER_ITEM_LAX_INCENSE,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_BASHFUL
    },
    [FRONTIER_MON_FELIGHT] = {
    ...
    [FRONTIER_MON_MYRIEPROM] = {
        .species = SPECIES_MYRIEPROM,
    ...
    [FRONTIER_MON_BANANEE] = {
        .species = SPECIES_BANANEE,
    ...
    [FRONTIER_MON_SALANANA] = {
        .species = SPECIES_SALANANA,
    ...
    [FRONTIER_MON_BEWONDER] = {
        .species = SPECIES_BEWONDER,
    ...
    [FRONTIER_MON_AMBLAZIA] = {
        .species = SPECIES_AMBLAZIA,
        .moves = {MOVE_SPORE, MOVE_LEECH_LIFE, MOVE_SLASH, MOVE_LIGHT_SCREEN},
        .itemTableId = BATTLE_FRONTIER_ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_RELAXED
    },
    [FRONTIER_MON_BATRACHITE] = {
        .species = SPECIES_BATRACHITE,
    ...
    [FRONTIER_MON_BANSHARK] = {
        .species = SPECIES_BANSHARK,
    ...
    [FRONTIER_MON_TEPILLA] = {
        .species = SPECIES_TEPILLA,
    ...
    [FRONTIER_MON_FEISTYCUFF] = {
        .species = SPECIES_FEISTYCUFF,
    ...
    [FRONTIER_MON_CAFFINERGY] = {
        .species = SPECIES_CAFFINERGY,
        .moves = {MOVE_ACID, MOVE_STUN_SPORE, MOVE_SWEET_SCENT, MOVE_MOONLIGHT},
        .itemTableId = BATTLE_FRONTIER_ITEM_PECHA_BERRY,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_RELAXED
    },
    [FRONTIER_MON_THUNDAIJU] = {
        .species = SPECIES_THUNDAIJU,
    ...
    [FRONTIER_MON_COILARVA] = {
        .species = SPECIES_COILARVA,
    ...
    [FRONTIER_MON_SILWING] = {
        .species = SPECIES_SILWING,
        .moves = {MOVE_TWINEEDLE, MOVE_PURSUIT, MOVE_ENDEAVOR, MOVE_AGILITY},
        .itemTableId = BATTLE_FRONTIER_ITEM_SCOPE_LENS,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_NAUGHTY
    },
    [FRONTIER_MON_VENTRILETTE] = {
        .species = SPECIES_VENTRILETTE,
    ...
    [FRONTIER_MON_SOBANDIT_1] = {
        .species = SPECIES_SOBANDIT,
    ...
    [FRONTIER_MON_NITTLE_1] = {
        .species = SPECIES_NITTLE,
    ...
    [FRONTIER_MON_KNUCKOUT_1] = {
        .species = SPECIES_KNUCKOUT,
    ...
    [FRONTIER_MON_BANAGON_1] = {
        .species = SPECIES_BANAGON,
    ...
    [FRONTIER_MON_REBUGGER_1] = {
        .species = SPECIES_REBUGGER,
    ...
    [FRONTIER_MON_TOAGNITIVE_1] = {
        .species = SPECIES_TOAGNITIVE,
        .moves = {MOVE_POISON_FANG, MOVE_DIG, MOVE_BITE, MOVE_GLARE},
        .itemTableId = BATTLE_FRONTIER_ITEM_PERSIM_BERRY,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_KURAIJIN_1] = {
        .species = SPECIES_KURAIJIN,
    ...
    [FRONTIER_MON_QUARDIAN_1] = {
        .species = SPECIES_QUARDIAN,
    ...
    [FRONTIER_MON_AMPRABICA_1] = {
        .species = SPECIES_AMPRABICA,
        .moves = {MOVE_AIR_CUTTER, MOVE_CONFUSE_RAY, MOVE_TOXIC, MOVE_STEEL_WING},
        .itemTableId = BATTLE_FRONTIER_ITEM_SCOPE_LENS,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_RELAXED
    },
    [FRONTIER_MON_ARACHTITE_1] = {
        .species = SPECIES_ARACHTITE,
    ...
    [FRONTIER_MON_FLUTTERPOP_1] = {
        .species = SPECIES_FLUTTERPOP,
    ...
    [FRONTIER_MON_CARRIONETTE_1] = {
        .species = SPECIES_CARRIONETTE,
    ...
    [FRONTIER_MON_TADEA_1] = {
        .species = SPECIES_TADEA,
    ...
    [FRONTIER_MON_ASTROHAUT_1] = {
        .species = SPECIES_ASTROHAUT,
    ...
    [FRONTIER_MON_SEARTICA_1] = {
        .species = SPECIES_SEARTICA,
    ...
    [FRONTIER_MON_MORPHYDRA_1] = {
        .species = SPECIES_MORPHYDRA,
        .moves = {MOVE_SLUDGE_BOMB, MOVE_DOUBLE_KICK, MOVE_BODY_SLAM, MOVE_COUNTER},
        .itemTableId = BATTLE_FRONTIER_ITEM_FOCUS_BAND,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_LIAYARD_1] = {
        .species = SPECIES_LIAYARD,
    ...
    [FRONTIER_MON_SWORMO_1] = {
        .species = SPECIES_SWORMO,
    ...
    [FRONTIER_MON_BEWARER_1] = {
        .species = SPECIES_BEWARER,
        .moves = {MOVE_FLAMETHROWER, MOVE_ROAR, MOVE_CONFUSE_RAY, MOVE_WILL_O_WISP},
        .itemTableId = BATTLE_FRONTIER_ITEM_RAWST_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MODEST
    },
    [FRONTIER_MON_GRAPPOUCH_1] = {
        .species = SPECIES_GRAPPOUCH,
    ...
    [FRONTIER_MON_LEVIAMAWL_1] = {
        .species = SPECIES_LEVIAMAWL,
