...
// Odd, all the other Youngster/Lass trainers of this group have Overscrill, but one does not
#define FRONTIER_MONS_YOUNGSTER_LASS_2_NO_OVERSCRILL \
...
#define FRONTIER_MONS_YOUNGSTER_LASS_2 \
    ...
    FRONTIER_MONS_YOUNGSTER_LASS_2_NO_OVERSCRILL
...
{
    FRONTIER_MONS_BUG_CATCHER_1_EXTRA(COATOAC, FELIGHT)
};
