...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_HIGH_JUMP_KICK] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("HiJumpKick", "High Jump Kick"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_EXHAUST_FUME] =
    {
        .name = COMPOUND_STRING("Exhaust Fume"),
        .description = COMPOUND_STRING(
            "Releases a hot miasma that\n"
            "may burn or poison the foe."),
        .effect = EFFECT_HIT,
        .power = 75,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_MEMORY_LEAK] =
    {
        .name = COMPOUND_STRING("Memory Leak"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DATA_TRANSFER] =
    {
        .name = COMPOUND_STRING("DataTransfer"),
        .description = COMPOUND_STRING(
            "Transfers the opponent's\n"
            "stat changes to the user."),
        .effect = EFFECT_PSYCH_UP,
        .power = 0,
        .type = TYPE_DATA,
        .accuracy = 0,
